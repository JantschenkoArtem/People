...
public class PrintPeopleLivingInHousesEndingWith1 {
    public static void peopleLivingInHousesEndingWith1(Person[]people){
        for (Person person:people){
            if (person.getAddress().getHousesNumber()==1){
                System.out.println(
                       "лицa, живущиe в домах, номера которых заканчиваются на 1: " + person.getFirstName() + person.getLastName());
            }
        }
    }
}
